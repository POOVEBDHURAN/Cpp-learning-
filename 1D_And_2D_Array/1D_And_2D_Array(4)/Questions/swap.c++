...
class Solution {
public:
void swapElements(int matrix[][3], int pos1Row, int pos1Col, int pos2Row, int pos2Col, int size) {
...
int size = 3;
int pos1Row = 0, pos1Col = 1; // Position of the first element to swap
int pos2Row = 2, pos2Col = 1; // Position of the second element to swap
Sol.swapElements(matrix, pos1Row, pos1Col, pos2Row, pos2Col, size);
